export default {
  ...
  chat: {
    ...
    emptyState: 'Start a conversation with SciClaw Agent',
  ...
  mcp: {
    ...
    invalidHeaders: 'Invalid HTTP headers format',
    loadError: 'Failed to load',
    reloadError: 'Failed to reload',
    testSuccess: 'Connection successful ({name}), found {count} tools',
    testFailed: 'Connection failed ({name}): {error}',
    testError: 'Test failed',
    testOk: 'Test passed, {count} tools',
    deleteSuccess: 'Deleted server {name}',
    deleteError: 'Delete failed',
    deleteConfirm: 'Are you sure you want to delete {name}?',
    addSuccess: 'Added server {name}',
    addError: 'Add failed',
    updateSuccess: 'Updated server {name}',
    ...
    connect: 'Start',
    disconnect: 'Stop',
    connectSuccess: 'Successfully started {name}, found {count} tools',
    connectFailed: 'Failed to start {name}: {error}',
    connectError: 'Error starting server',
    disconnectSuccess: '{name} stopped',
    disconnectFailed: 'Failed to stop {name}: {error}',
    disconnectError: 'Error stopping server',
  },
