export default {
  ...
  mcp: {
    ...
    updateError: '更新失败',
    enabledSuccess: '服务器已启用',
    disabledSuccess: '服务器已禁用',
    toggleError: '切换状态失败',
    editServer: '编辑服务器',
    addNewServer: '添加新服务器',
    ...
    connect: '启动',
    disconnect: '停止',
    connectSuccess: '已成功启动 {name}，发现 {count} 个工具',
    connectFailed: '启动 {name} 失败: {error}',
    connectError: '启动服务器出错',
    disconnectSuccess: '{name} 已停止',
    disconnectFailed: '停止 {name} 失败: {error}',
    disconnectError: '停止服务器出错',
  },
